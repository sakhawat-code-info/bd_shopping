...
//       {/* Social Icons Bar */}
//       <section className="flex justify-end items-center gap-3 border-b border-gray-300 px-4 sm:px-10 py-2 text-gray-700 text-sm">
//         <FaInstagram />
//         <FaFacebook />
//         <FaBell />
//       </section>
...
//                   className={`${
//                     special
//                       ? "text-2xl lg:text-3xl font-extrabold text-slate-900"
//                       : "text-sm hover:text-black text-slate-700"
//                   }`}
//                 >
//                   {label}
//                 </Link>
